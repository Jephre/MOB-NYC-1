...
class MainTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // why is it necessary to add ["name"] to the end of tasks[indexPath.row] to access the dictionary value? Is that convention to use [][]? 
        // Also, why am I forced to use a string instead of an int
